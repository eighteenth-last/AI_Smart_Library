          ...
          <n-scrollbar style="max-height: calc(100vh - 380px);" ref="scrollbarRef">
            <div class="messages-container">
              ...
              <div v-if="messages.length === 0" class="welcome-screen">
                ...
                <p class="welcome-subtitle">我可以帮助您解答关于图书管理的问题，包括：</p>
                <div class="quick-actions">
                  <n-button type="info" size="medium" ghost @click="sendQuickQuestion('如何提升作品阅读量？')">
                    📈 如何提升作品阅读量？
                  </n-button>
                  <n-button type="info" size="medium" ghost @click="sendQuickQuestion('如何回复读者的问题？')">
                    💬 如何回复读者的问题？
                  </n-button>
                  <n-button type="info" size="medium" ghost @click="sendQuickQuestion('如何查看作品数据统计？')">
                    📊 如何查看作品数据统计？
                  </n-button>
                  <n-button type="info" size="medium" ghost @click="sendQuickQuestion('如何优化作品介绍？')">
                    ✍️ 如何优化作品介绍？
                  </n-button>
                </div>
              </div>
...
import { chatWithAI, getSessions, saveSession, deleteSession, getSessionMessages, type SessionVO, type ChatHistoryItem } from '@/api/author/ai'
